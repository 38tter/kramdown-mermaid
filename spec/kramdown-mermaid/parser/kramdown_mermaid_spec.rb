        ...
        expect(ast[:children]).to eq(
          [{ type: :header, options: { level: 1, raw_text: 'some title', location: 1 },
           ...
           { type: :ul,
             ...
             children: [{ type: :li, options: { location: 3 },
                          children: [{ type: :p, options: { location: 3, transparent: true },
                                       children: [{ type: :text, value: 'a', options: { location: 3 } }] }] },
                        { type: :li,
                          options: { location: 4 },
                          children: [{ type: :p, options: { location: 4, transparent: true },
                                       children: [{ type: :text, value: "b\n", options: { location: 4 } }] },
                                     { type: :ul,
                                       options: { location: 5, first_list_marker: '-' },
                                       children: [{ type: :li, options: { location: 5 },
                                                    children: [{ type: :p, options: { location: 5, transparent: true },
                                                                 children: [{ type: :text, value: 'cc',
                                                                              options: { location: 5 } }] }] },
                                                  { type: :li, options: { location: 6 },
                                                    children: [{ type: :p, options: { location: 6, transparent: true },
                                                                 children: [{ type: :text, value: 'dd',
                                                                              options: { location: 6 } }] }] }] }] }] },
           { type: :blank, value: "\n" },
           ...
           { type: :p, options: { location: 9 },
             children: [{ type: :text, value: 'ccc ', options: { location: 9 } },
                        { type: :strong, options: { location: 9 },
                          children: [{ type: :text, value: 'ddd',
                                       options: { location: 9 } }] },
                        { type: :text, value: ' eee', options: { location: 9 } }] },
           { type: :blank, value: "\n" },
           ...
           { type: :p, options: { location: 12 },
             children: [
               { type: :img,
                 attr: { 'src' => 'https://en.wikipedia.org/wiki/Wikimedia_Commons#/media/File:Commons-logo-en.svg',
                         'alt' => 'Wikimedia', 'title' => 'Wikimedia' }, options: { location: 12, ial: nil } }
             ] },
           { type: :blank, value: "\n" },
           ...
           { type: :entity,
             ...
             options: { entity: 'fugas',
                        attributes: [{ type: 'bigint', name: 'id', constraint: 'PK' },
                                     ...
                                     { type: 'datetime', name: 'updated_at', constraint: nil }], location: 31 } },
           { type: :relation, value: "\n\nhoges |o--o{  fugas: \"some comment\"\n",
             options: {
               left_entity: 'hoges', left_relation: '|o', right_relation: 'o{', right_entity: 'fugas', location: 33
             } },
           { type: :relation, value: "piyos |o--|| hoges: \"some comment\"\n",
             options: {
               left_entity: 'piyos', left_relation: '|o', right_relation: '||', right_entity: 'hoges', location: 34
             } },
           { type: :relation, value: "fugas ||--o{ hoges: \"\"\n",
             options: {
               left_entity: 'fugas', left_relation: '||', right_relation: 'o{', right_entity: 'hoges', location: 35
             } }]
        )
      end
    end
